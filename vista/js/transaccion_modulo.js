	...
	//-------------------------------------------------------------------
		...
		btn_cancelar.style.display	="inline";
			...
			btn_cancelar.disabled		=false;
					...
					$("#cam_cod_modulo").click(function(){
					cam_cod_modulo.readOnly=true;
					$.ajax({  
    				type: "POST",  
    				url: "../controladores/control_transaccion_modulo.php?consultar_ultimo_numero=1",  
    				data: {consultar_ultimo_numero:"1"},  
    				success: function(msg){  
					
					cam_cod_modulo.value=msg;
					cam_cod_modulo.readOnly=false;
...
$("#cam_cod_modulo").change(function() { 
	...
	var usr = $("#cam_cod_modulo").val();
			...
			$("#status").html('<img src="imagenes/loader.gif" align="absmiddle">&nbsp;Analizando...');
    			...
    			$.ajax({  
    				type: "POST",  
    				url: "../controladores/control_transaccion_modulo.php?verificar_id=1",  
    				data: {cod_modulo:usr,verificar:"1"},  
    				success: function(msg){  
