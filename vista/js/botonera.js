...
function Act(){
	...
	document.envio_form.inc.style.color = "#3A414F";
	document.envio_form.bus.style.background = "#ccc";
	document.envio_form.bus.style.color = "#3A414F";
	document.envio_form.mod.style.background = "#ccc";
	document.envio_form.mod.style.color = "#3A414F";
	document.envio_form.sta.style.background = "#ccc";
	document.envio_form.sta.style.color = "#3A414F";
	document.envio_form.grab.style.background = "#303641";
	document.envio_form.grab.style.color = "#fff";
	document.envio_form.cancel.style.background = "#303641";
...
function Encontrado_si(){
	...
	document.envio_form.bus.style.background = "#ccc";
	document.envio_form.bus.style.color = "#3A414F";
	document.envio_form.mod.style.background = "#303641";
	document.envio_form.mod.style.color = "#fff";
	document.envio_form.sta.style.background = "#303641";
	document.envio_form.sta.style.color = "#fff";
	document.envio_form.grab.style.background = "#ccc";
	document.envio_form.grab.style.color = "#3A414F";
	document.envio_form.cancel.style.background = "#303641";
	document.envio_form.cancel.style.color = "#fff";
}
function consultar(){
	...
	document.envio_form.inc.style.background = "#ccc";
	document.envio_form.inc.style.color = "#3A414F";
	document.envio_form.bus.style.background = "#303641";
...
function Inicio_Deafault(){
	...
	document.envio_form.inc.style.background = "#303641";
	...
	document.envio_form.cancel.style.color = "#3A414F";
	document.envio_form.cancel.style.background = "#ccc";
}
