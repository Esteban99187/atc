			       ...
			       <div class="login-form">
					    <div class="login-content">
							 <div class="form-login-error"> <h3>Invalid login</h3> <p>Enter <strong>demo</strong>/<strong>demo</strong> as login and password.</p> </div>
								 <form action ="../controlador/controlador_login.php" method="post" autocomplete="off" role="form" >
...
-->
								...
								if(isset($_GET["av"]))
								{
									...
									echo '<br><div class="alert '.$alerta[1].'" role="alert">
...
<!-- JavaScripts initializations and stuff --> <script src="js/neon-custom.js" id="script-resource-10"></script>
 <!-- Demo Settings --> <script src="js/neon-demo.js" id="script-resource-11"></script>
