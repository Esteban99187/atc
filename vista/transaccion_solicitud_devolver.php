		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
					<form method="post" name="fsolicitud_procesar" id="fsolicitud_procesar" action="../controlador/control_transaccion_solicitud.php" >
						<input type="hidden" name="txtoperacion" value="devolver_solicitud">
						...
						<div class="row"><hr><h5><center>Motivo de la Devolucion</h5></center><hr>
							<div class="form-group col-lg-12">
								<label >observacion:</label>
								<input class="form-control"   type="text" name="txtidtabulador"  value="<?php print($lsidtabulador);?>">
							</div>
						</div>
						<center>
							<button type="submit" name="btnguardar"   class="btn btn-lg btn-primary"  title="Clic para Guardar" onclick="fguardar();">Devolver</button>
							<button type="reset"  name="btncancelar"  class="btn btn-lg btn-primary" title="Clic para Cancelar"  onclick="cancelar('transaccion_solicitud_2')">Cancelar</button>
						</center>
					</form>
			</div>
		</div> 
...
<script language="javascript">
	...
	{
		miPopup = window.open("busqueda/CatalogoTabuladorProcesar.php","tabulador","width=650px,height=270px,scrollbars=yes,toolbar=No")
		miPopup.focus()
	}
	function multiplica()
	{
