   ...
   */
	...
	class clsFpdf extends FPDF
	{
		...
		public function Header()
		{
			...
			$this->Image('../imagenes/cintillo1.png',3,5,205,20);
			$this->Image('../../vista/imagenes/atc12.JPG',20,90,170,70);
			$this->SetY(35);
			//Arial bold 8
			...
			public function Footer()
		{
			...
			$this->SetFont("Arial","I",8);
			//Dirección
			$this->Cell(55,7,"Acarigua, Estado Portuguesa",0,1,"R");
			//Número de página
			$this->Cell(50,7,utf8_decode("Página ").$this->PageNo()."/{nb}",0,0,"R");
		}
	}
?>
