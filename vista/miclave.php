...
<li class="active"><a href="?url=miclave">Editar Contraseña</a></li>
<li><a href="?url=mispreguntas">Editar Preguntas de Seguridad</a></li> 
</ul> 
</div>
</div> 
</section>
				<form name="fmiclave" id="fmiclave" method="post" action="../controlador/controlador_usuario.php">
					<div class="row">
						<div class="col-xs-5">
					...
					<div class="row">
						<div class="col-xs-4">
							<div class="form-group">    
								<label>Clave:</label>
								<input type="password" name="Clave" id="Clave"  autocomplete="off" class="form-control" value="" /></td>
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
								<label>Nueva Clave:</label>
								<input type="password" name="NuevaClave" id="NuevaClave" autocomplete="off" class="form-control" value=""/></td>
							</div>
						</div>
						<div class="col-xs-4">
							<div class="form-group">
								<label>Repetir Clave:</label>
								<input type="password" name="RepetirClave" id="RepetirClave" autocomplete="off" class="form-control" value=""/></td>
							</div>
						</div>
					</div>
					<br>
					<center>
						...
						<button type="submit" class="btn btn-primary" name="opt" value="NuevaClave">Guardar</button>
						<button type="reset" class="btn btn-primary" onclick="cancelar('miclave')">Cancelar</button>
					</center>
