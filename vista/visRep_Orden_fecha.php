...
<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Orden de Carga por Fecha</div> </div> 
			 <br>
	...
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Orden_fecha.php">                                                       <!---->	
	...
	<!---->										<div class="form-group col-lg-6"><center>
													<label>Introduzca la cédula del Conductor</label>
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
											...
											<div class="form-group col-lg-12">
												<h4>Orden de Carga por Fecha</h4>
												...
												<tr>
													...
													for ($liI = 0; $liI < count($laMatriz); $liI++){
														...
														printf("<tr>");
															...
															printf("</td>");
															printf("<td>");
															printf ($laMatriz[$liI][3].' '.$laMatriz[$liI][4]); 
															printf("</td>");
															printf("<td>");
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Orden_fecha.php?lsbusqueda=<?php print($lsbusqueda);?>&lsfini=<?php print($lsfini);?>&lsfin=<?php print($lsfin);?>');
	}
