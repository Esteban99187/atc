<?php 
	...
	********************************************************************************************/
	...
	if(isset($_GET["act"]))
	{
		if($us->eliminar_responsabilidad($_GET["act"]))
		{
			echo '<script>window.location="admin.php?url=asignarResponsabilidades&av=2"</script>';
		}
		else
		{
			echo '<script>window.location="admin.php?url=asignarResponsabilidades&av=8"</script>';
		}
	}
?>
<div class="row spa">
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><div class="panel-title">Asignar Menu</div> 
				...
				<div class="panel-body">
								...
								<div class="form-group">
									...
									<select onChange="submit();" name="idCargo" class="form-control">
										<option value="0">Seleccione un Perfil</option>
											<?php
												$cargo = "-2";
												if(isset($_POST["idCargo"])) $cargo = $_POST["idCargo"];
												$sl->selectPerfil($cargo);
											?>
									</select>
								</div>
							</div>
					...
					<form name="fActividad" id="fActividad" method="post" action="../controlador/controlador_roles.php">
						<div class="row">
							<div class="col-md-12">
								<table class="table">
									<tr>
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<button type="reset" class="btn btn-primary" onclick="cancelar('asignarResponsabilidades')">Cancelar</button>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Seleccione un Menu</h4>
					<form name="agregarRespo" method="post" action="../controlador/controlador_agregar_responsabilidad.php">
						<table class="table">
							<tr>
								<th>Menus</th>
								<th></th>
						...
						<input type="submit" class="btn btn-primary" name="opt" value="Guardar"></input>
						<input type="button" onclick="cancelar('roles')" class="btn btn-primary" name="opt" value="Crear nuevo rol"></input>
					</form>
				</div>
			</div>
		</div>
