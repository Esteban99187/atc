	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Orden de Carga por Ciudad Destino</div> </div> 
			 <br>
	 						
	<!--------------------------------------------------CONTIENE EL FORMULARIO DE BUSQUEDA------------------------------------------------------------------------------------------>								
	<!---->						 		<div class="panel-body"><p align="center" style="color:#AB0000;">Ingrese ciudad origen destino y a continuación de click en el boton buscar</p>
										<div name="form" id="form"  align="center" >                                                                   <!---->
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Orden_tabulador_destino.php">                                                       <!---->	
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
											...
											<div class="form-group col-lg-12">
												<h4>Orden de Carga por Ciudad Destino</h4>
												...
												<tr>
													...
													for ($liI = 0; $liI < count($laMatriz); $liI++){
														...
														printf("<tr>");
															...
															printf("</td>");
															printf("<td>");
															printf ($laMatriz[$liI][16]); 
															printf("</td>");
															printf("<td>");
															printf ($laMatriz[$liI][15]); 
															printf("</td>");
															printf("<td>");
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	loF=document.form1;
	   ...
	   function fBusqueda(){
			...
			function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Orden_tabu_des.php?lsbusqueda=<?php print($lsbusqueda);?>');
	}
