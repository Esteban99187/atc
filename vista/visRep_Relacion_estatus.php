...
<div class="col-sm-12">
	<div class="panel panel-default">
		<div class="panel-heading"> 
			<div class="panel-title">Reporte de Relación de Unidades por Estatus</div> </div> 
				<br>
				...
				<div class="panel-body"><p align="center" style="color:#AB0000;">Seleccione un estatus del combo y a continuación de click en el boton buscar</p>
					<div name="form" id="form"  align="center" >
						<form name="form1" method="POST" action="../controlador/corRep_Relacion_estatus.php">
							...
							<div class="form-group col-lg-8">
								<center>
									<select name="cmbbusqueda" class="form-control">
										...
										<option value="activa"><p>Activa</p></option>
										<option value="viaje"><p>En viaje</p></option>
									</select>
								</center>
							</div>
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
				<div id="reportes" style="display: none;" align="center">
					<div class="form-group col-lg-12">
						<h4>Relación de Unidades por Estatus </h4>
							...
							<thead>
								<tr>
									...
									for ($liI = 0; $liI < count($laMatriz); $liI++)
									{
										...
										printf("</td>");
										printf("<td>");
										printf ($laMatriz[$liI][2].' '.$laMatriz[$liI][3]); 
										printf("</td>");
										printf("<td>");
...
<script type="text/javascript"> 
	...
	function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Relacion.php?lsbusqueda=<?php print($lsbusqueda);?>');
	}
</script>
