		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
					<form method="post" name="fsolicitud_procesar" id="fsolicitud_procesar" action="../controlador/control_transaccion_solicitud.php" >
						<input type="hidden" name="txtoperacion" value="anular_solicitud">
						...
						<div class="row"><hr><h5><center>Motivo de la anulacion</h5></center><hr>
							<div class="form-group col-lg-12">
						...
						<center>
							<button type="submit" name="btnguardar"   class="btn btn-primary"  title="Clic para Guardar" onclick="fguardar();">Anular</button>
							<button type="reset"  name="btncancelar"  class="btn btn-primary" title="Clic para Cancelar"  onclick="cancelar('?url=solicitud_procesada')">Cancelar</button>
						</center>
					</form>
			</div>
		</div> 
