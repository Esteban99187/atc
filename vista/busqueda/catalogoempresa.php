...
function ponPrefijo(cod, nomco, modelo, repre){ 
	opener.document.fsolicitud.txtidempresa.value = cod;
	opener.document.fsolicitud.txtnombre_razon_social_emp.value = nomco;
	opener.document.fsolicitud.txtcedula_cont.value = modelo;
	opener.document.fsolicitud.txtnombre_cont.value = repre;
	window.close()	
} 
</script> 
<style type="text/css">
...
<h1><?php 
	...
	<div class="col-md-5">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><a href="buscaempresa.php"><strong><i class="glyphicon glyphicon-arrow-left"></i></a>&nbsp;&nbsp;Seleccione Cliente</strong></div>
      ...
      <tr>
					...
					<?php
						if ($lista<0)
							...
							?>
					<th>
					  <input name="textfield"  type="text"value="<?php echo $codig ?>" size="10" onClick="ponPrefijo(this.value, '<?php echo $nomb?>', '<?php echo $modelo?>', '<?php echo $repre?>')">
					</th>
					<th>
					  <input name="textfield2" class="form-control" type="text" size="150" readonly value="<?php echo $nomb?>" size="15">
				</th>
				  <?php }?>
			</tr>
    </tbody> 
