...
<fieldset>
	...
	<a href="rep_pdf/pdfRep_Ordencargal.php?lsa=-" style="text-decoration: none;color:#000000;"><img src="images/pdf.png" width="80" style="margin:20px 0px 0px 90px;" title="Descargar" height="80" /></a>
	...
	<a href="rep_pdf/pdfRep_ .php?lsa=-" style="text-decoration: none;color:#000000;"><img src="images/pdf.png" width="80" style="margin:20px 0px 0px 140px;" title="Descargar" height="80" /></a>
	<a href="rep_pdf/pdfRep_ .php?lsa=1" style="text-decoration: none;color:#000000;"><img src="images/pdf.png" width="80" style="margin:20px 0px 0px 140px;" title="Descargar" height="80" /></a>
...
<legend class="label" style="margin:30px 0px 15px 340px;">Buscar autorizacion</legend>
<form name="form1" action="">

<input type="text" name="busquedaautorizacion" style="width:180px;height:25px;margin:0px 0px 0px 310px;" value="">
...
<input type="button" name="btnAbrecam" value="buscar" class="boton3" onClick="enviar();	">
    ...
    <script type="text/javascript" languaje="javasript">
        ...
        function enviar(){
         var buscar=f.busquedaautorizacion.value;

            if(f.busquedaautorizacion.value!=""){
               miPopup = window.open("rep_pdf/pdfRep_autorizacion.php?lsa="+buscar,"Banco","width=1333px,height=630px,scrollbars=yes,toolbar=No");   
            }
            else{ alert("Vacio");
				}
        }
