	...
	<head> 
		...
		<script> 
			...
			{ 
				...
				window.close("buscapersonal.php") 
				} 
		  ...
		  <fieldset style="width:470;background:#F7F7F7;" id="formu">		
			<form action="../controlador/corcatalogo.php" method="post" name="formulario" id="formulario" OnSubmit="return validar(this)">
			 <table border="0" align="left" cellspacing="0" >
			  <tr>
				<td colspan="1" style="background:url(../img/colores3.jpg);radius: 6px 6px 0px 0px;-moz-border-radius: 6px 6px 0px 0px;-webkit-border-radius : 5px 4px 0px 0px;" width="470"><p style="font-family:arial;color:#FFFFFF;margin:0px 35px 0px 55px;">Consulta de Estado</p></td>
			  </tr>
			  <tr>
				<td colspan="2">
				  <table border="0" align="left" >
					<tr>
					  <td>&nbsp </td>
					  <td><br><p style="font-family:arial;margin:0px 0px 0px 70px;">cedula:</p></td>
					...
					<tr>
					  <td>&nbsp </td>
					  <td><p style="font-family:arial;margin:0px 0px 0px 10px;">Nombre:</p></td>
					...
					<tr>
					  <td colspan="3"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
						...
						<input name="catalogo" type="hidden" id="catalogo" value="11">
						</div></td>
					  </tr>
				  </table></td>
				</tr>
