	...
	<body style="background: #FAFAFA"> 
		<h1>
			<?php 
				...
				$lista    = $objEquipo->CatalogoUnidad();
				if($lista=="99")
				{
			?>
			<script> 
			...
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><div class="panel-title"><a href="CatalogoUnidadReluni.php"><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Unidad de Transporte</a>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaUnidadReluni.php"><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Unidad de Transporte</a></div></div>
