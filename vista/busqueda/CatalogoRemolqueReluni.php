	...
	<body style="background:#FAFAFA;"> 
		<h1>
			<?php 
				...
				$lista    = $objEquipo->CatalogoRemolque();
				if($lista=="99")
				{
			?>
			<script> 
			...
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><div class="panel-title"><a href="CatalogoRemolqueReluni.php"><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Remolque</a>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaRemolqueReluni.php"><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Remolque</a></div></div>
