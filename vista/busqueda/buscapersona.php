	...
	<head> 
		...
		<script> 
			...
			{ 
				...
				window.close("buscapersona.php") 
				} 
				var miPopup 
				function abreVentana(){ 
					window.close(this);
					miPopup = window.open("../vistas/viscohvestsolicitud.php","miwin","width=700,height=600,scrollbars=yes,toolbar=No") 
					miPopup.focus()
			} 
		</script> 
...
<link href="../css/maestro.css" type="text/css" rel="stylesheet" />
	...
	<body style="background:url(../imagenes/fondo2.png);"> 
		  ...
		  <fieldset style="width:470;background:#F7F7F7;" id="formu">		
			<form action="../../controladores/corcatalogo.php" method="post" name="formulario" id="formulario" OnSubmit="return validar(this)">
			 <table border="0" align="left" cellspacing="0" >
			  <tr>
				<td colspan="1" style="background:url(../imagenes/colores3.jpg);radius: 6px 6px 0px 0px;-moz-border-radius: 6px 6px 0px 0px;-webkit-border-radius : 5px 4px 0px 0px;" width="470"><p style="font-family:arial;color:#FFFFFF;margin:0px 35px 0px 55px;">Consulta de conductor</p></td>
			  </tr>
			  <tr>
				<td colspan="2">
				  <table border="0" align="left" >
					<tr>
					  <td>&nbsp </td>
					  <td><br><p style="font-family:arial;margin:0px 0px 0px 90px;">cedula:</p></td>
					...
					<tr>
					  <td>&nbsp </td>
					  <td><p style="font-family:arial;margin:0px 0px 0px 85px;">nombre:</p></td>
					...
					<tr>
					  <td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
						...
						<input type="button" onclick="flistar();" value="Listar      " class="boton2" 	/> 
						<input name="catalogo" type="hidden" id="catalogo" value="34">
						</div></td>
					  </tr>
				  </table></td>
				</tr>
		  ...
		  <script language="javascript">
                                ...
                                function flistar()
                                    { 
                                            mipopup = window.open("../../vista/lista/listapersonal2.php","miwin","width=1300,height=650,scrollbars=yes"); 
                                            mipopup.focus();	
                                    }
                    </script>
		</div>
