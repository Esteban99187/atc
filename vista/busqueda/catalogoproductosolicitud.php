...
function ponPrefijo(cod, nomco, modelo, repre, unid){ 
	opener.document.fsolicitud.txtidproducto.value = cod;
	opener.document.fsolicitud.txtnombre_pro.value = nomco;
	opener.document.fsolicitud.txtnombre_tippro.value = modelo;
	opener.document.fsolicitud.txtnombre_tipuni.value = repre;
	opener.document.fsolicitud.txtnombre_unimed.value = unid;
	window.close()	
} 
</script> 
<style type="text/css">
...
<h1><?php 
				...
				$lista    = $objEquipo->flistadoproductosolicitud();
				if($lista=="99")				
				{	
				?>
				<script> 
	...
	<div class="col-md-5">
		<div class="panel panel-default">
			<div class="panel-heading"><a href="catalogoproductosolicitud.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Productos</strong></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="buscaproductosoli.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Productos</strong></a></div>
