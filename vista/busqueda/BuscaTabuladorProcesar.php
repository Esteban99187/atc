		...
		<div class="row spa">
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="CatalogoTabuladorProcesar.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Tabulador</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaTabuladorProcesar.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda Tabulador</strong></a>
					</div>
							...
							<table>
								<tr>
									<td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
										...
										<input name="catalogo" type="hidden" id="catalogo" value="62">
									</td>
								</tr>
							</table>
						</form>
