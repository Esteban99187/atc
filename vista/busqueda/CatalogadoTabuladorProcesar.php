	...
	background: linear-gradient(to bottom, rgba(216,96,96,0.13) 0%,rgba(216,96,96,0.13) 100%); /* W3C */ filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#21d86060', endColorstr='#21d86060',GradientType=0 ); /* IE6-9 */"> 
		<h1>
			<?php 
				...
				$cod=$_GET["id1"]; 
				$nombre=$_GET["id2"]; 
				$lista    = $objEquipo->BuscaTabulador($cod,$nombre);
				if($lista=="99")
				{
			?>
			<script> 
		...
		<div class="row spa">
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="CatalogoTabuladorProcesar.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Tabulador</strong></a>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaTabuladorProcesar.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Tabulador</strong></a></div>
							...
							<table class="table table-bordered table-striped table-hover">
								...
								<tbody>
									<tr>
										...
										?>
										<th><input name="textfield"  class="form-control" type="text"           value="<?php echo $codig ?>"  onClick="ponPrefijo(this.value, '<?php echo $precio_total_vto?>', '<?php echo $ciudad_origen_vto?>', '<?php echo $ciudad_destino_vtd?>', '<?php echo $tipo_uniad_vto?>', '<?php echo $capacidad_vto?>')"></th>
