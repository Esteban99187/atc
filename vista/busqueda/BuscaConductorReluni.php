		...
		<div class="row spa">
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="CatalogoConductorReluni.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo Persona</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaConductorReluni.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda Persona</strong></a>
					</div>
							...
							<table>
								<tr>
									<td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
										...
										<input name="catalogo" type="hidden" id="catalogo" value="65">
									</td>
								</tr>
							</table>
						</form>
