...
<legend class="label" style="margin:30px 0px 15px 340px;">Buscar Orden de Carga</legend>
        ...
        function enviar(){
         var buscar=f.busquedacam.value;
            ...
            if(f.busquedacam.value!=""){
               miPopup = window.open("rep_pdf/pdfRep_Ordencarga.php?lsa="+buscar,"Banco","width=1333px,height=630px,scrollbars=yes,toolbar=No");   
            }
            else{ alert("Vacio");
				}
        }
