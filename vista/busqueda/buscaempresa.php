...
background: linear-gradient(to bottom, rgba(216,96,96,0.13) 0%,rgba(216,96,96,0.13) 100%); /* W3C */ filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#21d86060', endColorstr='#21d86060',GradientType=0 ); /* IE6-9 */"> 
	...
	<div class="col-md-5">
		<div class="panel panel-default">
			<div class="panel-heading"><a href="catalogoclientesolicitud.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Clientes</strong></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="buscaproductosoli.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Clientes</strong></a></div>
    ...
    <tbody>
      <tr>
        <th>RIF</th>
					  ...
					  <th><input type="checkbox" name="checkbox" value="checkbox" onClick="desactivar(this)">
					  </th>
					</tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <th>Razon Social</th>
					  ...
					  <th>
					 <input type="checkbox" name="checkbox2" value="checkbox" onClick="desactivar2(this)">
					  </th>
					</tr>
    </tbody> 
		</table>	 
					...
					<tr>
					  <td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
						...
						<input name="catalogo" type="hidden" id="catalogo" value="6">
						</div></td>
					  </tr>
				  </table></td>
				</tr>
