		...
		<div class="row spa">
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="CatalogoRuta.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Rutas</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaRuta.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Rutas</strong></a>
					</div>
							...
							<table>
								<tr>
									<td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
										...
										<input name="catalogo" type="hidden" id="catalogo" value="61">
									</td>
								</tr>
							</table>
						</form>
