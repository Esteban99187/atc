		...
		<div class="row spa">
			<div class="col-md-5">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="CatalogoUnidadReluni.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Unidad de Transporte</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="BuscaUnidadReluni.php"><strong><i class="glyphicon glyphicon-folder-open"></i>Busqueda de Unidad de Transporte</strong></a>
					</div>
							...
							<table>
								<tr>
									<td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
										...
										<input name="catalogo" type="hidden" id="catalogo" value="63">
									</td>
								</tr>
							</table>
						</form>
