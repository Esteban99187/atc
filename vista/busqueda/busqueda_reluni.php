...
<div class="row spa">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><div class="panel-title">Reporte de Relación de Unidades</div> 
				...
				<div class="panel-body">
					...
					<center><h4>Ingrese Número de Cédula del Conductor</h4></center>
...
<script type="text/javascript" languaje="javasript">
	...
	function enviar()
	{
		...
		{
			miPopup = window.open("../vista/reporte/pdfRep_Relacion1.php?lsa="+buscar_reporte,"Banco","width=1333px,height=630px");   
		}
		else
		{
			alert("Vacio");
