...
<legend class="label" style="margin:30px 0px 15px 340px;">Buscar Reportes por Fechas</legend>
<form name="form1" action="">

<input type="text" name="busquedapercontra" style="width:180px;height:25px;margin:0px 0px 0px 310px;" value="">
 ...
 <input type="button" class="boton3" value="buscar" onClick="enviar();	">
    ...
    <script type="text/javascript" languaje="javasript">
        ...
        function enviar(){
         var buscar=f.busquedapercontra.value;
            if(f.busquedapercontra.value!=""){
                window.location=("rep_pdf/pdfRep_percontra.php?lsa="+buscar);   
            }
            else{ alert("Vacio");
				}
        }
