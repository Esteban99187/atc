...
<legend class="label" style="margin:30px 0px 15px 340px;">Buscar Solicitud</legend>
<form name="form1" action="">

<input type="text" name="busquedasoli" style="width:180px;height:25px;margin:0px 0px 0px 310px;" value="">
 ...
 <input type="button" value="buscar" class="boton3" onClick="enviar();	">
    ...
    <script type="text/javascript" languaje="javasript">
        ...
        function enviar(){
         var buscar=f.busquedasoli.value;
            if(f.busquedasoli.value!=""){
                window.location=("rep_pdf/pdfRep_solicitudt.php?lsa="+buscar);   
            }
            else{ alert("Vacio");
				}
        }
