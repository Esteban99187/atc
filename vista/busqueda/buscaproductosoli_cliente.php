	...
	<head> 
		...
		<script> 
			...
			{ 
				...
				window.close("buscaproductosoli.php") 
				} 
				var miPopup 
...
background: linear-gradient(to bottom, rgba(216,96,96,0.13) 0%,rgba(216,96,96,0.13) 100%); /* W3C */ filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#21d86060', endColorstr='#21d86060',GradientType=0 ); /* IE6-9 */"> 
	...
	<div class="col-md-5">
		<div class="panel panel-default">
			<div class="panel-heading"><a href="catalogoproductosolicitud_cliente.php"><strong><i class="glyphicon glyphicon-align-justify"></i>Catalogo de Productos</strong></a>
        ...
        <th>Nombre</th>
					...
					<tr>
					  <td colspan="4"><div align="center"><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
						...
						<input name="catalogo" type="hidden" id="catalogo" value="52">
						</div></td>
					  </tr>
				  </table></td>
				</tr>
