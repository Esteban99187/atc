...
<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Bitacora por Fecha</div> </div> 
			 <br>
	...
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Bitacora_fecha.php">                                                       <!---->	
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Bitacora_fecha.php?lsbusqueda=<?php print($lsbusqueda);?>&lsfini=<?php print($lsfini);?>&lsfin=<?php print($lsfin);?>');
	}
