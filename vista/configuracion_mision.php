...
<div class="row spa">
	<div class="col-md-12">
		<form name="fSistema" id="fSistema" method="post" action="../controlador/controlador_configuracion_mision.php">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><div class="panel-title">Configuración del Contenido Misión</div> 
					...
					<div class="panel-body">
						<div class="row">
							<div class="form-group col-lg-12">
								<textarea class="form-control" name="mision"><?php if(isset($cadena)){ echo $cadena[0]; } ?></textarea>
							</div>
						</div>
						<div class="col-md-12">
							<div class="row">
