							...
							<div class="row">
								<div class="form-group col-lg-4">
									<div class="center-block">
										<img class="img-responsive" src="imagenes/proc.png" alt="">
									</div>
								</div>
								<div class="row">
									<div class="form-group col-lg-6">
										<h1 style="color:#DB4D4D">SU SOLICITUD HA SIDO PROCESADA CORRECTAMENTE</h1>
										<h2>Se espera confirmacion departe del cliente</h2><br>
