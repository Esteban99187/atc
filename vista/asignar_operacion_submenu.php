<?php 
	...
	********************************************************************************************/
	...
	$sl = new selects;
	$us = new class_asignar_operacion_submenu;
	if(isset($_GET["edit"]))
	{
	...
	if(isset($_GET["act"]))
	{
		if($us->eliminar_asignacion_operacion_submenu($_GET["act"]))
		{
			echo '<script>window.location="admin.php?url=asignar_operacion_submenu&av=2"</script>';
		}
		else
		{
			echo '<script>window.location="admin.php?url=asignar_operacion_submenu&av=8"</script>';
		}
	}
?>
<div class="row spa">
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><div class="panel-title">Asignar Operacion - SubMenu</div> 
				...
				<div class="panel-body">
						...
						<div class="row">
							<div class="col-xs-3">
								<div class="form-group">
									...
									<select onChange="submit();" name="IdSubmenu" class="form-control">
					...
					<form name="fActividad" id="fActividad" method="post" action="../controlador/controlador_asignar_operacion_submenu.php">
						<div class="row">
							<div class="col-md-12">
								<table class="table">
									<tr>
									...
									<tr>
									<?php
										$us->RecuperarOperacion($IdSubmenu);
										/* 
										$us->ListaAsignacion();
										*/ 
									?>
						...
						<div class="row">
							<div class="col-lg-6">
								<input type="hidden" name="idCargo2" value="<?php echo $_POST["IdSubmenu"] ?>">
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<form name="agregarRespo" method="post" action="../controlador/controlador_agregar_operacion_submenu.php">
						<table class="table">
							<tr>
								<th>Submenu</th>
								<th></th>
						...
						<input type="hidden" name="IdSubmenu" value="<?php echo $_POST["IdSubmenu"] ?>">
						<input type="submit" class="btn btn-primary" name="opt" value="Guardar"></input>
