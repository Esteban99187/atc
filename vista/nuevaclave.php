							...
							<div class="row">
								...
								<div class="row">
									<div class="form-group col-lg-12">
										<h2 style="color:#DB4D4D">Cambio de Clave Realizado Exitosamente</h2><br>
										<h4>Recuerde que al ingresar al sistema  se le solicitara su nombre de usuario. Y su nueva clave asignada</h4></div>
									</div>
