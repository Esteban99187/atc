<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   require_once("../modelo/clsRep_ordencargal.php");   
   $lobjPdf=new clsFpdf();
   $lobjPdf->AliasNbPages();
   $lobjPdf->AddPage("L","Legal");
   $lobjPdf->SetMargins(30,30,30);
   $lobjPdf->SetFont("arial","B",12);
   $lobjclsRep_ordencargal= new clsRep_ordencargal();
   $lsa=$_GET["lsa"];
   $lobjclsRep_ordencargal->fSetsbusqueda($lsa);
   $laMatriz=$lobjclsRep_ordencargal->fBusqueda();
