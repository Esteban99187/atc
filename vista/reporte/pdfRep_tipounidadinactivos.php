<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $laMatriz=$lobjclass_tipo_unidad->flistainactivos(); //aqui solo cambia el llamado del listar que esta en la clase, tiene que hacerse diferentes listar para cada pdf
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(45,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Listado de Tipo de Unidades Inactivas de la Empresa ATC .C.A."),0,1,"C");
       ...
       $lobjPdf->Cell(60,6,utf8_decode("Capacidad"),1,1,"C");
