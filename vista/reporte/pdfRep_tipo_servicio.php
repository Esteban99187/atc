<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $lobjclass_tipo_servicio= new class_tipo_servicio();
   $lsa= isset($_GET['lsa']) ? $_GET['lsa'] : null;
   $lobjclass_tipo_servicio->flistar($lsa);
   $laMatriz=$lobjclass_tipo_servicio->flistar();
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(60,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Reporte de Tipos de Servicios de la Empresa ATC .C.A."),0,1,"C");
