<?php
	...
	require_once("../../modelo/clsRep_Recepcion_conductor.php");   
	$lobjPdf=new clsFpdf();
	$lobjPdf->AliasNbPages();
	$lobjPdf->AddPage("L","Legal");
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->SetFont("arial","B",12);
	$lobjclsRep_Recepcion_conductor= new clsRep_Recepcion_conductor();
	...
	$lobjclsRep_Recepcion_conductor->fSetsbusqueda($lsbusqueda);
	$lobjclsRep_Recepcion_conductor->fSetsfini($lsfini);
	$lobjclsRep_Recepcion_conductor->fSetsfin($lsfin);
	$laMatriz=$lobjclsRep_Recepcion_conductor->fBusqueda(); 
	
	$lobjPdf->SetY(40);
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->Cell(0,6,utf8_decode("Listado de Recepción de Guia por Conductor"),0,1,"C");
