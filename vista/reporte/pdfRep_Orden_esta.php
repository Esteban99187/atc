<?php
	...
	require_once("../../modelo/clsRep_Orden_estatus.php");   
	$lobjPdf=new clsFpdf();
	$lobjPdf->AliasNbPages();
	$lobjPdf->AddPage("L","Legal");
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->SetFont("arial","B",12);
	$lobjclsRep_Orden_estatus= new clsRep_Orden_estatus();
	$lsbusqueda= isset($_GET['lsbusqueda']) ? $_GET['lsbusqueda'] : null;
	$lobjclsRep_Orden_estatus->fSetsbusqueda($lsbusqueda);
	$lobjclsRep_Orden_estatus->fBusqueda($lsbusqueda);
	$laMatriz=$lobjclsRep_Orden_estatus->fBusqueda(); 
	
	$lobjPdf->SetY(40);
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->Cell(0,6,utf8_decode("Listado de Orden de Carga por Estatus"),0,1,"C");
