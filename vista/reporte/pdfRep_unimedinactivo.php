<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $lobjclass_unidad_medida= new class_unidad_medida();
   $lsa= isset($_GET['lsa']) ? $_GET['lsa'] : null;
   $lobjclass_unidad_medida->flistar($lsa);
   $laMatriz=$lobjclass_unidad_medida->flistainactivos(); //aqui solo cambia el llamado del listar que esta en la clase, tiene que hacerse diferentes listar para cada pdf
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(75,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Listado de Unidades de Medida Inactivos"),0,1,"C");
