<?php
	...
	require_once("../../modelo/clsRep_Solicitud_rif.php");   
	$lobjPdf=new clsFpdf();
	$lobjPdf->AliasNbPages();
	$lobjPdf->AddPage("L","Legal");
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->SetFont("arial","B",12);
	$lobjclsRep_Solicitud_rif= new clsRep_Solicitud_rif();
	$lsbusqueda= isset($_GET['lsbusqueda']) ? $_GET['lsbusqueda'] : null;
	$lobjclsRep_Solicitud_rif->fSetsbusqueda($lsbusqueda);
	$lobjclsRep_Solicitud_rif->fBusqueda($lsbusqueda);
	$laMatriz=$lobjclsRep_Solicitud_rif->fBusqueda(); 
	
	$lobjPdf->SetY(40);
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->Cell(0,6,utf8_decode("Listado de Solicitudes por Rif"),0,1,"C");
	...
	$lobjPdf->Cell(50,6,utf8_decode("Rif"),1,0,"C");
