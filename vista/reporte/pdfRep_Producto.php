<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $laMatriz=$lobjclass_producto->flistar();
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(25,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Lista de Productos de la Empresa ATC .C.A."),0,1,"C");
       ...
       $lobjPdf->Cell(20,6,utf8_decode("Tipo"),1,0,"C");
       $lobjPdf->Cell(35,6,utf8_decode("Unidad de Medida"),1,0,"C");
       $lobjPdf->Cell(35,6,utf8_decode("Tipo de Transporte"),1,1,"C");
	   ...
	   for($liI=0;$liI<count($laMatriz);$liI++){
		...
		$lobjPdf->Cell(35,6,utf8_decode($laMatriz[$liI][5]),1,1,"C");
