<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $laMatriz=$lobjclass_capacidad->flistar();
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(40,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Listado de Capacidad de las Unidades de la Empresa ATC .C.A."),0,1,"C");
       ...
       $lobjPdf->Cell(70,6,utf8_decode("Capacidad"),1,0,"C");
       $lobjPdf->Cell(50,6,utf8_decode("Unidad de Medida"),1,1,"C");
	   ...
	   for($liI=0;$liI<count($laMatriz);$liI++){
		...
		$lobjPdf->Cell(50,6,utf8_decode($laMatriz[$liI][3]),1,1,"C");
