<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $lobjPdf->Cell(0,6,utf8_decode("Listado de Departamentos de la Empresa ATC .C.A."),0,1,"C");
   ...
   $lobjPdf->Cell(50,6,utf8_decode("Teléfono"),1,1,"C");
