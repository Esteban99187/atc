<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $laMatriz=$lobjclass_tipo_cuenta->flistaractvos(); //aqui solo cambia el llamado del listar que esta en la clase, tiene que hacerse diferentes listar para cada pdf
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(75,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Listado de Tipos de Cuenta Activos de la Empresa ATC .C.A."),0,1,"C");
