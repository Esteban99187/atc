<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   require_once("../modelo/class_chofer.php");   
   $lobjPdf=new clsFpdf();
   $lobjPdf->AliasNbPages();
   $lobjPdf->AddPage("L","Legal");
   $lobjPdf->SetMargins(30,30,30);
   $lobjPdf->SetFont("arial","B",12);
   $lobjclsRep_ordencarga= new chofer();
   $lsa=$_GET["lsa"];
   $lobjclsRep_ordencarga->fSetsbusqueda($lsa);
   $laMatriz=$lobjclsRep_ordencarga->fBusqueda();
      ...
      $lobjPdf->SetY(40);
	   ...
	   $lobjPdf->Cell(40,6,utf8_decode("estatus"),1,1,"C");
