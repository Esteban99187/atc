<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   require_once("../modelo/clsRep_Ordencarga2.php");   
   $lobjPdf=new clsFpdf();
   $lobjPdf->AliasNbPages();
   $lobjPdf->AddPage("L","Legal");
   $lobjPdf->SetMargins(30,30,30);
   $lobjPdf->SetFont("arial","B",12);
   $lobjclsRep_Ordencarga2= new clsRep_Ordencarga2();
   $lsa=$_GET["lsa"];
   $lobjclsRep_Ordencarga2->fSetsbusqueda($lsa);
   $laMatriz=$lobjclsRep_Ordencarga2->fBusqueda();
