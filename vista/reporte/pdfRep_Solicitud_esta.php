<?php
	...
	require_once("../../modelo/clsRep_Solicitud_estatus.php");   
	$lobjPdf=new clsFpdf();
	$lobjPdf->AliasNbPages();
	$lobjPdf->AddPage("L","Legal");
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->SetFont("arial","B",12);
	$lobjclsRep_Solicitud_estatus= new clsRep_Solicitud_estatus();
	$lsbusqueda= isset($_GET['lsbusqueda']) ? $_GET['lsbusqueda'] : null;
	$lobjclsRep_Solicitud_estatus->fSetsbusqueda($lsbusqueda);
	$lobjclsRep_Solicitud_estatus->fBusqueda($lsbusqueda);
	$laMatriz=$lobjclsRep_Solicitud_estatus->fBusqueda(); 
	
	$lobjPdf->SetY(40);
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->Cell(0,6,utf8_decode("Listado de Solicitudes por Estatus"),0,1,"C");
	...
	$lobjPdf->Cell(30,6,utf8_decode("Hora"),1,0,"C");
	$lobjPdf->Cell(30,6,utf8_decode("Rif"),1,0,"C");
	$lobjPdf->Cell(30,6,utf8_decode("Teléfono"),1,0,"C");
	$lobjPdf->Cell(70,6,utf8_decode("Razón Social"),1,0,"C");
	$lobjPdf->Cell(70,6,utf8_decode("Direccion Entrega"),1,0,"C");
	$lobjPdf->Cell(70,6,utf8_decode("Direccion Salida"),1,1,"C");
	...
	for($liI=0;$liI<count($laMatriz);$liI++)
	{
		...
		$lobjPdf->Cell(70,6,utf8_decode($laMatriz[$liI][3]),1,0,"C");
		$lobjPdf->Cell(70,6,utf8_decode($laMatriz[$liI][4]),1,0,"C");
