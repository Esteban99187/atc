<?php
	...
	$lobjclsRep_Orden_tabulador_destino= new clsRep_Orden_tabulador_destino();
	$lsbusqueda= isset($_GET['lsbusqueda']) ? $_GET['lsbusqueda'] : null;
	$lobjclsRep_Orden_tabulador_destino->fSetsbusqueda($lsbusqueda);
	$lobjclsRep_Orden_tabulador_destino->fBusqueda($lsbusqueda);
	$laMatriz=$lobjclsRep_Orden_tabulador_destino->fBusqueda(); 
	
	$lobjPdf->SetY(40);
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->Cell(0,6,utf8_decode("Listado de Orden de Carga por Ciudad Destino"),0,1,"C");
