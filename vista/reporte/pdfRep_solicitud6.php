<?php
	...
	$carballo='http://localhost/atcsistem/vista/reporte/pdfRep_solicitud6.php?lsa=';
	...
	$lobjsolicitud->flistarpdf1();
	$laMatriz=$lobjsolicitud->flistarpdf1();
   ...
   $lobjPdf->SetY(50);
	...
	$lobjPdf->Cell(165,5,utf8_decode("Datos del Cliente "),0,1,"C");
		...
		$lobjPdf->Cell(40,6,utf8_decode($laMatriz[$liI][9]),1,0,"C");
		$lobjPdf->Cell(40,6,utf8_decode($laMatriz[$liI][6]),1,0,"C");
		$lobjPdf->Cell(30,6,utf8_decode($laMatriz[$liI][8]),1,1,"C");
		$lobjPdf->Cell(20);
		$lobjPdf->SetFont("arial","B",8);
		...
		$lobjPdf->Cell(30,6,utf8_decode($laMatriz[$liI][12]),1,0,"C");
		$lobjPdf->Cell(40,6,utf8_decode($laMatriz[$liI][14]),1,0,"C");
		$lobjPdf->Cell(40,6,utf8_decode($laMatriz[$liI][11]),1,0,"C");
		$lobjPdf->Cell(30,6,utf8_decode($laMatriz[$liI][13]),1,1,"C");
		$lobjPdf->Cell(20);
		$lobjPdf->SetFont("arial","B",8);
		...
		$lobjPdf->SetFont("arial","B",11);
		$lobjPdf->Cell(20);
		$lobjPdf->Cell(165,5,utf8_decode("Producto "),1,1,"C");
