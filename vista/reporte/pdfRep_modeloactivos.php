<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   ...
   $laMatriz=$lobjclass_modelo_unidad->flistaractivos(); //aqui solo cambia el llamado del listar que esta en la clase, tiene que hacerse diferentes listar para cada pdf
													
      $lobjPdf->SetY(40);
	   $lobjPdf->SetMargins(55,30,0);
	   $lobjPdf->Cell(0,6,utf8_decode("Listado del Modelo de Unidades Activos de la Empresa ATC .C.A."),0,1,"C");
