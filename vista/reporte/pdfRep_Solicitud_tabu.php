<?php
	...
	$lobjclsRep_Solicitud_tabulador= new clsRep_Solicitud_tabulador();
	$lsbusqueda= isset($_GET['lsbusqueda']) ? $_GET['lsbusqueda'] : null;
	$lobjclsRep_Solicitud_tabulador->fSetsbusqueda($lsbusqueda);
	$lobjclsRep_Solicitud_tabulador->fBusqueda($lsbusqueda);
	$laMatriz=$lobjclsRep_Solicitud_tabulador->fBusqueda(); 
	
	$lobjPdf->SetY(40);
	$lobjPdf->SetMargins(20,20,20);
	$lobjPdf->Cell(0,6,utf8_decode("Listado de Solicitud por Ciudad Origen"),0,1,"C");
