	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Solicitudes por Ciudad Origen</div> </div> 
			 <br>
	 						
	<!--------------------------------------------------CONTIENE EL FORMULARIO DE BUSQUEDA------------------------------------------------------------------------------------------>								
	<!---->						 		<div class="panel-body"><p align="center" style="color:#AB0000;">Introduzca una ciudad origen y a continuación de click en el boton buscar</p>
										<div name="form" id="form"  align="center" >                                                                   <!---->
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Solicitud_tabulador.php">                                                       <!---->	
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
											...
											<div class="form-group col-lg-12">
												<h4>Solicitudes por Ciudad Origen</h4>
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	loF=document.form1;
	   ...
	   function fBusqueda(){
		...
		function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Solicitud_tabu.php?lsbusqueda=<?php print($lsbusqueda);?>');
	}
