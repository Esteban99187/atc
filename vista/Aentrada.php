<?php 
    ...
    require_once("../controlador_alberto/corAentrada.php");
	include_once("componentes_alberto.php");
?>
<div id='contenedor_formulario' >
	<div id='titulo_form'>Entrada de productos</div>
	<form method="post">
		<table width='100%' id='formulario_persona'>
			<tr>
				...
				<td style="width: 180px;"><b>Tipo de entrada: </b></td>
				<td>
					<select title="Seleccione el tipo de entrada" name="txtOpcion" id="opcion" class="form-control requerido">
						<option value="">Seleccione una Opción</option>
						<option value="1">Inventario Inicial</option>
						<option value="2">Ajuste por Entrada</option>
					</select>
				</td>
				<td><b>N° de entrada: </b></td>
				<td><input type="text" name="txtNroEntrada" class="form-control requerido" readonly="readonly" value="<?php echo (isset($ultimaEntrada))?$ultimaEntrada:'' ?>"></td>
			</tr>
			<!--<tr id="responsableTR">
				<td><b>Responsable: </b></td>
				<td style="position: relative;">
					<input title="Ingrese el nombre del responsable" placeholder="Cédula, nombre del responsabe" validar="requerido" type="text" name="txtResponsable" class="form-control requerido" id="personal" >
		...
		<table width="100%">
			<tr>
				...
				<td>
					<textarea class="form-control requerido" title="Ingrese información adicional referente a la entrada" placeholder="Escriba información adicional" validar="200" class="area" name="txtObservacion"></textarea>
				</td>
			</tr>
		</table>
		<table>
...
<script type="text/javascript">
	...
	$(function(){
		...
		mensajeConfirmar("Entrada Registrada Con exito, \xbf Desea imprimir el comprobante de entrada?",function(){
