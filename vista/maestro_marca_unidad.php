<?php 
	include_once('../controlador_alberto/cormarca_unidad.php');
	include_once("componentes_alberto.php"); 
 ?>

<div id='contenedor_formulario' >
<div id='titulo_form'>Marca de Unidad</div>
<form action=''  id='formulario_maestro' method='POST'>
	<table width='100%' id='formulario_persona'>
		...
		<tr style="display:none;">
		 	<td>id_marca</td>
		 	<td><input type='text' class=''  name='idmarca_unidad' value='<?php if($existe!="yes"){print($codigoMarca["idmarca_unidad"]+1);} print($rows["idmarca_unidad"]); ?>' ></td>
		</tr>

		<tr>
		 	<td><span style="color:red;" >*</span>Nombre</td>
		 	<td><input type='text' style='float:left; width:80%;' maxlength="24" class='letranumeros <?php if($existe!='yes') print('campo campoclave'); ?>'  name='desc_marc' value='<?php print($rows["desc_marc"]); ?>' ><input type='submit' value='buscar' name='buscar' style='width:10%; display:none;' class='mibusqueda'></td>
		</tr>
	</table>
	<ol id='botonera'>
	...
	<div id="ventana_modal">
		...
		<div style="height:400px; overflow:auto;">
			<table width="100%" cellpadding="0" cellspacing="0" id="table_modal">
				...
				<tr>
					<td><?php print($lista['idmarca_unidad']); ?></td>
					<td><?php print($lista['desc_marc']); ?></td>
					<td><?php echo ($lista["estatus_maruni"])?"Activo":"Inactivo"; ?></td>
