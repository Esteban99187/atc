...
<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Recepción de Guia por Fecha</div> </div> 
			 <br>
	...
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Recepcion_fecha.php">                                                       <!---->	
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
											...
											<div class="form-group col-lg-12">
												<h4>Recepción de guia por fechas</h4>
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Recepcion_fecha.php?lsbusqueda=<?php print($lsbusqueda);?>&lsfini=<?php print($lsfini);?>&lsfin=<?php print($lsfin);?>');
	}
