	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Orden de Carga por Estatus</div> </div> 
			 <br>
	 					
	<!--------------------------------------------------CONTIENE EL FORMULARIO DE BUSQUEDA------------------------------------------------------------------------------------------>								
	<!---->						 		<div class="panel-body"><p align="center" style="color:#AB0000;">Seleccione un estatus del combo y a continuación de click en el botón buscar</p>	
										<div name="form" id="form"  align="center" >                                                                   <!---->
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Orden_estatus.php">                                                       <!---->	
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
											...
											<div class="form-group col-lg-12">
												<h4>Orden de Carga por Estatus </h4>
												...
												<tr>
													...
													for ($liI = 0; $liI < count($laMatriz); $liI++){
														...
														printf("<tr>");
															...
															printf("</td>");
															printf("<td>");
															printf ($laMatriz[$liI][12].' '.$laMatriz[$liI][13]); 
															printf("</td>");
															printf("<td>");
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	loF=document.form1;
	   ...
	   function fBusqueda(){
		...
		function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Orden_esta.php?lsbusqueda=<?php print($lsbusqueda);?>');
	}
