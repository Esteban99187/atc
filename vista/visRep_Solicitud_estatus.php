...
<link rel="stylesheet" href="css/bootstrap.css" id="style-resource-4"> 
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Solicitudes por Estatus</div> </div> 
			 <br>
	 
	<!--------------------------------------------------CONTIENE EL FORMULARIO DE BUSQUEDA------------------------------------------------------------------------------------------>								
	<!---->						 		<div class="panel-body"><p align="center" style="color:#AB0000;">Seleccione un estatus del combo y a continuación de click en el boton buscar</p>						
										<div name="form" id="form"  align="center" >                                                                   <!---->
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Solicitud_estatus.php">                                                       <!---->	
	...
	<!---->										<div class="form-group col-lg-8"><center>
													<select name="cmbbusqueda" class="form-control">                                                                                       <!---->	
	<!---->													<option value="-"><p>    Todos los Estatus    </p></option>                                                                            <!---->	
	<!---->													<option value="espera"><p>en espera</p></option>                                                                           <!---->	
	<!---->													<option value="procesada"><p>procesada</p></option>                                                                           <!---->	
	<!---->													<option value="emitida"><p>emitida</p></option>                                                                                 <!---->	
	<!---->													<option value="ejecutada"><p>ejecutada</p></option>                                                                                 <!---->	
	<!---->													</select> </center> </div>                                                                                                              <!---->	
	...
	<table class="table datatable">
		<thead>
												<tr>
													...
													<th><strong>Dirección Entrega</strong></th>
													<th><strong>Dirección Salida</strong></th>
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	loF=document.form1;
	   ...
	   function fBusqueda(){
			...
			function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Solicitud_esta.php?lsbusqueda=<?php print($lsbusqueda);?>');
	}
