...
<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading"> 
				<div class="panel-title">Reporte de Recepción de Guia por Conductor</div> </div> 
			 <br>
	 				
	<!--------------------------------------------------CONTIENE EL FORMULARIO DE BUSQUEDA------------------------------------------------------------------------------------------>								
	<!---->						 		<div class="panel-body"><p align="center" style="color:#AB0000;">Ingrese las fechas y a continuación de click en el boton buscar</p>		
										<div name="form" id="form"  align="center" >                                                                   <!---->
	<!---->									<form name="form1" method="POST" action="../controlador/corRep_Recepcion_conductor.php">                                                       <!---->	
	...
	<!---->										<div class="form-group col-lg-6"><center>
													<label>Introduzca la cedula del Conductor</label>
...
<!--------------------------------------------------------------------DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
											...
											<div class="form-group col-lg-12">
												<h4>Recepción de guia por conductor</h4>
												...
												<tr>
													...
													for ($liI = 0; $liI < count($laMatriz); $liI++){
														...
														printf("<tr>");
															...
															printf("</td>");
															printf("<td>");
															printf ($laMatriz[$liI][12]); 
															printf("</td>");
															printf("<td>");
															printf ($laMatriz[$liI][13]); 
															printf("</td>");
...
<!--------------------------------------------------------------------FIN DIV QUE CONTIENE BUSQUEDA DE TODOS LOS TIPOS DE EVALUACION---------------------------------------------------------->
	...
	function Imprimir()
	{
		miPopup = window.open('../vista/reporte/pdfRep_Recepcion_conductor.php?lsbusqueda=<?php print($lsbusqueda);?>&lsfini=<?php print($lsfini);?>&lsfin=<?php print($lsfin);?>');
	}
