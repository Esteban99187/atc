					...
					<form method="post" name="fsolicitud" id="fsolicitud" action="../controlador/control_transaccion_solicitud.php" >
						...
						<div class="row"><h5><center>Datos del Cliente</h5></center><hr>							
							<div class="form-group col-lg-1">
									<label >Buscar</label><button class="btn btn-primary"  type="button" value="..."  title="Buscar Cliente" name="btnAbreempresa"  onclick="abreempresa()"><i class="glyphicon glyphicon-search"></i></button>
							</div>
							<div class="form-group col-lg-2">
									<label >RIF</label>
									<input class="form-control"  type="text" name="txtidcliente" readonly onkeypress="return soloNumero(event)" title="Ingrese RIF" maxlength="12" tabindex="2"   value="<?php print($lsidcliente);?>"> 
							</div>
							<div class="form-group col-lg-3">
									<label >Razón Social</label>
									<input class="form-control" readonly type="text" name="txtnombre_cli" maxlength="30" tabindex="2"  value="<?php print($lsnombre_cli);?>">
							</div>
							<div class="form-group col-lg-3">
									<label >Teléfono</label>
									<input class="form-control" readonly  type="text" name="txttelefono_cli" maxlength="12"  tabindex="2"  value="<?php print($lstelefono_cli);?>">
							</div>
							<div class="form-group col-lg-3">
									<label >Correo Electronico</label>
									<input class="form-control" readonly  type="text" name="txtcorreo_cli"  tabindex="2"  value="<?php print($lscorreo_cli);?>">
							</div>
						</div>   
						<div class="row"><h5><center>Tabulador de Precio por Kilometro</h5></center><hr>
							...
							<div class="form-group col-lg-2">
								...
								<input class="form-control" readonly name="cmbidpais_origen_tabulador" id="cmbidpais_origen_tabulador" value="<?php print($lsidpais_origen_tabulador);?>">
							</div>
							<div class="form-group col-lg-2">
								<label >Estado Origen:</label>
								<input class="form-control" readonly name="cmbidestado_origen_tabulador" id="cmbidestado_origen_tabulador" value="<?php print($lsidestado_origen_tabulador);?>">
							</div>
							<div class="form-group col-lg-2">
								<label >Municipio Origen:</label>
								<input class="form-control" readonly  name="cmbidmunicipio_origen_tabulador" id="cmbidmunicipio_origen_tabulador" value="<?php print($lsidmunicipio_origen_tabulador);?>">
							</div>
							<div class="form-group col-lg-2">
								<label >Parroquia Origen:</label>
								<input class="form-control" readonly name="cmbidparroquia_origen_tabulador" id="cmbidparroquia_origen_tabulador" value="<?php print($lsidparroquia_origen_tabulador);?>">
							</div>
							<div class="form-group col-lg-3">
								<label >Ciudad Origen:</label>
								<input class="form-control" readonly  name="cmbidciudad_origen_tabulador" id="cmbidciudad_origen_tabulador" value="<?php print($lsidciudad_origen_tabulador);?>">
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-2">
								<label >Fecha de Origen:</label>
								<input class="form-control"  type="text" readonly name="txtfecha_salida"  id="datepicker"   tabindex="2"  value="<?php print($lsfecha_salida);?>"> 
							</div>
						...
						<div class="row">
							<div class="form-group col-lg-2">
								...
								<input class="form-control" readonly name="cmbidpais_destino_tabulador" id="cmbidpais_destino_tabulador" value="<?php print($lsidpais_destino_tabulador);?>">
							</div>
							<div class="form-group col-lg-2">
								<label >Estado Destino:</label>
								<input class="form-control" readonly name="cmbidestado_destino_tabulador" id="cmbidestado_destino_tabulador" value="<?php print($lsidestado_destino_tabulador);?>">
							</div>
							<div class="form-group col-lg-2">
								<label >Municipio Destino:</label>
								<input class="form-control" readonly  name="cmbidmunicipio_destino_tabulador" id="cmbidmunicipio_destino_tabulador" value="<?php print($lsidmunicipio_destino_tabulador);?>">
							</div>
							<div class="form-group col-lg-3">
								<label >Parroquia Destino:</label>
								<input class="form-control" readonly name="cmbidparroquia_destino_tabulador" id="cmbidparroquia_destino_tabulador" value="<?php print($lsidparroquia_destino_tabulador);?>">
							</div>
							<div class="form-group col-lg-3">
								<label >Ciudad Destino:</label>
								<input class="form-control" readonly  name="cmbidciudad_destino_tabulador" id="cmbidciudad_destino_tabulador" value="<?php print($lsidciudad_destino_tabulador);?>">
							</div>
							<div class="form-group col-lg-2">
								<label >Fecha de Destino:</label>
								<input class="form-control"  type="text" id="datepicker1" readonly name="txtfecha_entrega" tabindex="2"  value="<?php print($lsfecha_entrega);?>">
							</div>
							<div class="form-group col-lg-10">
								<label >Direccion de Destino:</label>
								<input class="form-control"  type="text" name="txtdireccion_entrega"  maxlength="250" title="Ingrese Dirección de Destino" tabindex="2"  value="<?php print($lsdireccion_entrega);?>">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="form-group col-lg-3" style="margin-left:70px;">
								...
								<label >Precio Tabulador:</label>
								<input class="form-control" readonly  type="text" name="txtprecio_tabulador" id="txtprecio_tabulador"   value="<?php print($lsprecio_tabulador);?>">
								<label >Precio Total:</label>
								<input class="form-control"  type="text" name="txtprecio_sol"  id="txtprecio_sol"  readonly  value="<?php print($lsprecio_sol);?>"> 
							</div>
							<br>
						</div>
						<center>
							<button type="button" name="btnnuevo"     class="btn btn-lg btn-primary"  title="Clic para Registrar" onclick="fnuevo();">Nuevo</button>
							<button type="button" name="btnbuscar"    class="btn btn-lg btn-primary"  title="Clic para Consultar" onclick="fbuscar();">Consultar</button>
							<button type="button" name="btnguardar"   class="btn btn-lg btn-primary"  title="Clic para Guardar" onclick="fguardar();">Guardar</button>
							<button type="button" name="btneliminar" class="btn btn-lg btn-primary" title="Clic para Desactivar" onclick="Anular();" >Anular</button>
							<button type="reset"  name="btncancelar"  class="btn btn-lg btn-primary" title="Clic para Cancelar"  onclick="cancelar('transaccion_solicitud')">Cancelar</button>
						</center>
					</form>
			</div>
		</div> 
...
<script language="javascript">
	...
	function fguardar()
	{
		lof=document.fsolicitud;
			if (fvalidar())
			{
				...
				{
				alert("Debe seleccionar algun producto a transportar");
				return false;
				}
	...
	function addRow(tableID) 
	{
		...
		var TipoUnidad = document.getElementById('txtidtipo_unidad').value;
	...
	function recalcular()
	{
		...
		var precio=document.getElementById('txtprecio_tabulador').value;
		...
		document.getElementById('txtunidades_req').value= peso_totalr / capacidad;
		 var unidades=document.getElementById('txtunidades_req').value;
		document.getElementById('txtprecio_sol').value= parseFloat(precio)*parseFloat(unidades);
	}
	function fayuda()
	{
	...
	function abreempresa(){
		miPopup = window.open("busqueda/catalogoclientesolicitud.php","empresa","width=680px,height=350px,scrollbars=yes,toolbar=No")
		miPopup.focus()
	}
	var miPopup
	function abretabulador(){
		miPopup = window.open("busqueda/CatalogoTabuladorSolicitud.php","tabulador","width=1100px,height=350px,scrollbars=yes,toolbar=No")
		miPopup.focus()
	}
	        function fvalidar()
        {
            lbbueno=false;
            lof=document.fsolicitud;
            if (lof.txtidcliente.value=="")
            {
                alert("Debe seleccionar un Cliente");
            }
            else if (lof.txtidtabulador.value=="")
            {
                alert("debe seleccionar un tabulador de precios");
            }
            else if (lof.txtfecha_salida.value=="")
            {
                alert("Ingrese una Fecha origen");
            }
            else if (lof.txtfecha_entrega.value=="")
            {
                alert("Ingrese una Fecha Destino");
            }
            else if (lof.txtdireccion_salida.value=="")
            {
                alert("Ingrese una direccion origen");
            }
            else if (lof.txtdireccion_entrega.value=="")
            {
                alert("Ingrese una direccion destino");
            }
            else
            {
                lbbueno=true;
