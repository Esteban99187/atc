							...
							<div class="row">
								<div class="form-group col-lg-4">
									<div class="center-block">
										<img class="img-responsive" src="imagenes/soli.jpg" alt="">
									</div>
								</div>
-->
								<div class="row">
									<div class="form-group col-lg-6">
										<center><h2 style="color:#DB4D4D">Ayuda en Línea</h2></center>
										<h4>En este formulario "REGISTRO DE USUARIOS EXTERNOS" debes colocar lo siguiente:</h4>
										<p><i class="glyphicon glyphicon-ok"></i>Ingrese el nombre de usuario que desee.</p>
										<p><i class="glyphicon glyphicon-ok"></i>Deberas darle click al icono catálogo, la cual permitirá buscar el número de su cédula previamente registrado, al seleccionarlo
										mostrará su nombre, apellido, número de teléfono y correo.</p>
										<p>Finaliza el registro dando click al botón "GUARDAR".</p>
									</div>
									<div class="form-group col-lg-4">
									</div>
