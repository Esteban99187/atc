...
require_once("../../modelo/class_costo.php");
   ...
   $listado_costo = $lobjcosto->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista  Centro de Costos</strong></div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_costo);$i++){
						$idcosto=$listado_costo[$i][0];
						echo "".$idcosto."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_costo);$i++){
						$desc_costo=$listado_costo[$i][1];
						echo "".$desc_costo."<hr>"; 
							}	
						?></td>
