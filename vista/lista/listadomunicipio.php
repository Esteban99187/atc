...
require_once("../../modelo/class_municipio.php");
   ...
   $listado_municipio = $lobjmunicipio->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Municipio</strong></div>
        <div class="panel-body">
           <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Municipio.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
    ...
    <thead>
        ...
        <td><?php 
						...
						$idmunicipio=$listado_municipio[$i][0];
						echo "".$idmunicipio."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_municipio);$i++){
						$descripcion_ser=$listado_municipio[$i][3];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_municipio);$i++){
						$descripcion_ser=$listado_municipio[$i][1];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
