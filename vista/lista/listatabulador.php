...
require_once("../../modelo/class_tabulador.php");
   $lobj_tabulador= new class_tabulador();
   $listado_tabulador= $lobj_tabulador->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Tabuladores</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Tabulador.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_tabulador);$i++){
						$cedula=$listado_tabulador[$i][0];
						echo "".$cedula."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tabulador);$i++){
						$idarticulo=$listado_tabulador[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
       <td><?php 
						for($i=0;$i<count($listado_tabulador);$i++){
						$idarticulo=$listado_tabulador[$i][3];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tabulador);$i++){
						$idarticulo=$listado_tabulador[$i][4];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_tabulador);$i++){
						$idarticulo=$listado_tabulador[$i][5];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tabulador);$i++){
						$idarticulo=$listado_tabulador[$i][2];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
