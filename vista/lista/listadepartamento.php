...
require_once("../../modelo/class_departamento.php");
   $lobj_departamento= new class_departamento();
   $listado_departamento= $lobj_departamento->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista Tde Departameno</strong></div>
        <div class="panel-body">
             <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Departamento.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
        ...
        <td><?php 
						...
						$idarticulo=$listado_departamento[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_departamento);$i++){
						$idarticulo=$listado_departamento[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_departamento);$i++){
						$idarticulo=$listado_departamento[$i][2];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
