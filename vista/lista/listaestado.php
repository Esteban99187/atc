...
require_once("../../modelo/class_estado.php");
   ...
   $listado_estado = $lobjestado->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Estados</strong></div>
        <div class="panel-body">
             <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Estado.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_estado);$i++){
						$idestado=$listado_estado[$i][0];
						echo "".$idestado."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_estado);$i++){
						$descripcion_ser=$listado_estado[$i][1];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_estado);$i++){
						$descripcion_ser=$listado_estado[$i][3];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
      </tr>
