...
require_once("../../modelo/class_tipo_servicio.php");
   ...
   $listado_tipo_servicio = $lobjtipo_servicio->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Tipos de Servicios</strong></div>
        <div class="panel-body">
			<div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_tipo_servicio.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_tipo_servicio);$i++){
						$idtipo_servicio=$listado_tipo_servicio[$i][0];
						echo "".$idtipo_servicio."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tipo_servicio);$i++){
						$descripcion_tipser=$listado_tipo_servicio[$i][1];
						echo "".$descripcion_tipser."<hr>"; 
							}	
						?></td>
      </tr>
    </thead>
