...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Pais</strong></div>
        <div class="panel-body">
           <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Pais.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_pais);$i++){
						$idpais=$listado_pais[$i][0];
						echo "".$idpais."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_pais);$i++){
						$descripcion_ser=$listado_pais[$i][1];
