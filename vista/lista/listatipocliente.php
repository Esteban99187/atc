...
require_once("../../modelo/class_tipo_cliente.php");
   ...
   $listado_tipo_cliente= $lobjtipo_cliente->fListar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="panel-heading"><strong>Lista de Tipo de Cliente</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Tipocliente.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
...
<tr>
        <td><?php 
						for($i=0;$i<count($listado_tipo_cliente);$i++){
						$idarticulo=$listado_tipo_cliente[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tipo_cliente);$i++){
						$idarticulo=$listado_tipo_cliente[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
