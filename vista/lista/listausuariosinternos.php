...
require_once("../../modelo/class_usuarioatc.php");
   ...
   $listado_cliente= $lobjcliente->fListar3();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="panel-heading"><strong>Lista de Usuarios Internos|  <a href="listausuariosexternos.php">Lista de Usuarios Externos</a>|  <a href="listausuariosexternos2.php">Lista de Usuarios Externos Juridico</a></strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_usuariosinternos.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
