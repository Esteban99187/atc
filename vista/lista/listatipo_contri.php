...
require_once("../../modelo/class_tipo_contri.php");
   $lobj_tipo_contri= new class_tipo_contri();
   $listado_tipo_contri= $lobj_tipo_contri->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista Tipo de Contribuyente</strong></div>
        <div class="panel-body">
             <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Tipocontri.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_tipo_contri);$i++){
						$idarticulo=$listado_tipo_contri[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tipo_contri);$i++){
						$idarticulo=$listado_tipo_contri[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
