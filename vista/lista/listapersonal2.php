...
require_once("../../modelo/class_personaatc.php");
   ...
   $listado_personaatc= $lobj_personaatc->flistar2();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Conductor</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Personal2.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
       ...
       <td><?php 
        ...
        <td><?php 
						for($i=0;$i<count($listado_personaatc);$i++){
						$idarticulo=$listado_personaatc[$i][3];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_personaatc);$i++){
						$idarticulo=$listado_personaatc[$i][4];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
		...
		<td><?php 
						for($i=0;$i<count($listado_personaatc);$i++){
						$idarticulo=$listado_personaatc[$i][13];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
