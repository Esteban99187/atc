...
require_once("../../modelo/class_tipo_unidad.php");
   ...
   $listado_tipo_unidad = $lobjtipo_unidad->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Tipo de Unidad</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_tipo_unidad.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_tipo_unidad);$i++){
						$idtipo_unidad=$listado_tipo_unidad[$i][0];
						echo "".$idtipo_unidad."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_tipo_unidad);$i++){
						$descripcion_ser=$listado_tipo_unidad[$i][1];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_tipo_unidad);$i++){
						$descripcion_ser=$listado_tipo_unidad[$i][2];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
      </tr>
