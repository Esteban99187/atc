...
require_once("../../modelo/class_estatus.php");
   $lobj_estatus= new class_estatus();
   $listado_estatus= $lobj_estatus->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Estatus</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Estatus.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_estatus);$i++){
						$idarticulo=$listado_estatus[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_estatus);$i++){
						$idarticulo=$listado_estatus[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
