...
require_once("../../modelo/class_usuarioatc.php");
   ...
   $listado_cliente= $lobjcliente->fListar2();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="panel-heading"><strong>Lista de Usuarios Externos|  <a href="listausuariosexternos2.php">Lista de Usuarios Externos Juridicos</a>|  <a href="listausuariosinternos.php">Lista de Usuarios Internos</a></strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_usuariosexternos.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
