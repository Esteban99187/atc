...
require_once("../../modelo/class_capacidad.php");
   ...
   $listado_capacidad = $lobjcapacidad->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Capacidad</strong></div>
        <div class="panel-body">
           <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Capacidad.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_capacidad);$i++){
						$idcapacidad=$listado_capacidad[$i][0];
						echo "".$idcapacidad."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_capacidad);$i++){
						$descripcion_ser=$listado_capacidad[$i][1];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
		 <td><?php 
						for($i=0;$i<count($listado_capacidad);$i++){
						$descripcion_ser=$listado_capacidad[$i][3];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
