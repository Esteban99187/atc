...
require_once("../../modelo/class_parroquia.php");
   ...
   $listadoparroquia = $lobjparroquia->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Parroquias</strong></div>
        <div class="panel-body">
           <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Parroquia.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listadoparroquia);$i++){
						$idparroquia=$listadoparroquia[$i][0];
						echo "".$idparroquia."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listadoparroquia);$i++){
						$desc_parr=$listadoparroquia[$i][1];
						echo "".$desc_parr."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listadoparroquia);$i++){
						$desc_parr=$listadoparroquia[$i][2];
						echo "".$desc_parr."<hr>"; 
							}	
						?></td>
