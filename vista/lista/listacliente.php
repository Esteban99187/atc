...
require_once("../../modelo/class_cliente.php");
   ...
   $listado_cliente= $lobjcliente->fListar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="panel-heading"><strong>Lista de Clientes</strong></div>
        <div class="panel-body">
            ...
            <a href="../reporte/pdfRep_Cliente.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
 ...
 <td><?php 
						for($i=0;$i<count($listado_cliente);$i++){
						$idarticulo=$listado_cliente[$i][8];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_cliente);$i++){
						$idarticulo=$listado_cliente[$i][9];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_cliente);$i++){
						$idarticulo=$listado_cliente[$i][11];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
