...
require_once("../../modelo/class_unidad_medida.php");
   $lobj_unidad_medida= new class_unidad_medida();
   $listado_unidad_medida= $lobj_unidad_medida->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista Unidad de Medida</strong></div>
        <div class="panel-body">
             <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Unidadmedida.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
        ...
        <td><?php 
						...
						$idarticulo=$listado_unidad_medida[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_unidad_medida);$i++){
						$idarticulo=$listado_unidad_medida[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
