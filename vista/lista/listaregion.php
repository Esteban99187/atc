<?php
/***************************************************************
 * Nombre:Lista de Regiones.php
 * Descripcion:Listado de Regiones de ATC, C.A.
 * Fecha de creacion:abril 2014
 * Modificado:José Mogollón
 ***************************************************************/
...
require_once("../../modelo/class_region.php");
   ...
   $listado_Region = $lobjRegion->fListar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Región</strong></div>
        <div class="panel-body">
           <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Region.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_Region);$i++){
						$idregion=$listado_Region[$i][0];
						echo "".$idregion."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_Region);$i++){
						$desc_regi=$listado_Region[$i][1];
						echo "".$desc_regi."<hr>"; 
							}	
						?></td>
