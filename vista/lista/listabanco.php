...
require_once("../../modelo/class_banco.php");
   $lobj_banco= new class_banco();
   $listado_banco= $lobj_banco->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Bancos</strong></div>
        <div class="panel-body">
             <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Banco.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_banco);$i++){
						$idarticulo=$listado_banco[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_banco);$i++){
						$idarticulo=$listado_banco[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
