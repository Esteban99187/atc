...
require_once("../../modelo/class_remolque.php");
   $lobj_remolque= new class_remolque();
   $listado_remolque= $lobj_remolque->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading"><strong>Lista de Modelos de los Remolques</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_Remolque.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
        ...
        <td><?php 
						...
						$idarticulo=$listado_remolque[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_remolque);$i++){
						$idarticulo=$listado_remolque[$i][3];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
         <td><?php 
						for($i=0;$i<count($listado_remolque);$i++){
						$idarticulo=$listado_remolque[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_remolque);$i++){
						$idarticulo=$listado_remolque[$i][8];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_remolque);$i++){
						$idarticulo=$listado_remolque[$i][5];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_remolque);$i++){
						$idarticulo=$listado_remolque[$i][6];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
         <td><?php 
						for($i=0;$i<count($listado_remolque);$i++){
						$idarticulo=$listado_remolque[$i][7];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
