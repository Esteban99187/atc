...
require_once("../../modelo/class_tipo_producto.php");
   $lobjTproducto = new class_tipo_producto();
   $listado_Tproducto= $lobjTproducto->fListar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="panel-heading"><strong>Lista de Tipo de producto</strong></div>
        <div class="panel-body">
            <div class="row">
				<div class="form-group col-lg-10"></div>
            <a href="../reporte/pdfRep_tipoproducto.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
 <td><?php 
						for($i=0;$i<count($listado_Tproducto);$i++){
						$idarticulo=$listado_Tproducto[$i][0];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_Tproducto);$i++){
						$idarticulo=$listado_Tproducto[$i][1];
						echo "".$idarticulo."<hr>"; 
							}	
						?></td>
