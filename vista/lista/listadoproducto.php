...
require_once("../../modelo/class_producto.php");
   ...
   $listado_producto = $lobjproducto->flistar();
...
<div class="container" style="margin-top:10px;">
	...
	<div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <a href="../reporte/pdfRep_Productos.php?lsa=-"><input type="button" class="btn btn-primary btn-lg" value="Imprimir        " title="Click aqui para Imprimir"></a>
            </div>
    ...
    <thead>
		...
		<tr>
        <td><?php 
						for($i=0;$i<count($listado_producto);$i++){
						$idproducto=$listado_producto[$i][0];
						echo "".$idproducto."<hr>"; 
							}	
						?></td>
        <td><?php 
						for($i=0;$i<count($listado_producto);$i++){
						$desc_prod=$listado_producto[$i][1];
						echo "".$desc_prod."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_producto);$i++){
						$descripcion_ser=$listado_producto[$i][2];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_producto);$i++){
						$descripcion_ser=$listado_producto[$i][4];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
		<td><?php 
						for($i=0;$i<count($listado_producto);$i++){
						$descripcion_ser=$listado_producto[$i][5];
						echo "".$descripcion_ser."<hr>"; 
							}	
						?></td>
      </tr>
