...
require_once("../../modelo/class_marca_unidad.php");
   $lobjMunidad = new class_marca_unidad();
   $listado_Munidad = $lobjMunidad->fListar();
...
<body style="background:url(../imagenes/fondo2.png);">
	...
	<legend class="label2" style="font-family:arial;border-radius:6px 6px 0px 0px;">Listado de Marca de Unidad</legend>
	<a href="../reporte/pdfRep_Marcaunidad.php"><input type="button" class="botonimp" style="margin:10px 0px 10px 240px;" value="Imprimir     " title="Click aqui para Imprimir"></a>
        <table border="0" align="center">
			<tr>
												...
												<?php
													for ($i=0;$i<count($listado_Munidad);$i++){
														printf("<tr align=center>");
															printf("<th colspan='2' style=font-family:arial;padding:3px;background:#FFCECE;>");
															printf ($id_personal=$listado_Munidad[$i][0]);
															printf("</th>");
															printf("<th colspan='2' style=font-family:arial;padding:3px;background:#FFCECE;>");
															printf ($nombre1_per=$listado_Munidad[$i][1]);
															printf("</th>");
															printf("</tr>");
													}
