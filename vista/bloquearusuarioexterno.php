 <?php 
  ...
  {
    if($us->DesbloquearUsuariosExternos($_GET["act"],$_GET["ect"]))
    {
       echo '<script>window.location="admin.php?url=bloquearusuarioexterno&av=10"</script>';
    }else{
        echo '<script>window.location="admin.php?url=bloquearusuarioexterno&av=8"</script>';
    }
  }
?>
<div class="row spa">
...
<!-- PANEL FORMULARIOS -->
     ...
     <div class="panel-heading"><div class="panel-title">Bloquear usuario externo</div> 
      ...
      <div class="panel-body">
        ...
        <div clas="row">
          ...
          <input type="submit" class="btn btn-primary" name="opt" value="Desactivarexterno"></input>
          <button type="reset" class="btn btn-primary" onclick="cancelar('bloquearusuarioexterno')">Cancelar</button>
        </div>
...
<div class="col-md-6">
    ...
    <!-- FIN DE OPERACIONES -->
      <div class="panel panel-default">
        <div class="panel-heading"><div class="panel-title">Desbloquear usuarios externos</div> 
				<div class="panel-options">  <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a> <a href="#" data-rel="reload"><i class="entypo-arrows-ccw"></i></a> <a href="#" data-rel="close"><i class="entypo-cancel"></i></a></div>
				</div>
        <div class="panel-body">
    ...
    <tbody>
    <?php
    $us->listar_usuariosex_bloqueados();
    ?>
    </tbody>
  </table>
        </div>
