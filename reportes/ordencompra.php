<?php
	...
	if(isset($_GET["nro"])){
		...
		$datos = $objSolicitud->ReporteOrdenCompra($_GET["nro"]);
...
<div>
    ...
    <center>
        <p style="font-size:20px; font-weight:bold; border: 1px solid black; width:320px; margin: 10px auto; display: inline-block;">ORDEN DE COMPRA <span style="font-weight: 100"> Nro: '.$_GET[nro].'</span> </p> 
    <center>
    <table class="table table-condensed" border=0>
        <tr>
            <td>Fecha de Solicitud '.$objSolicitud->set_fecha($datos[0]["fechapedido"]).'</td>
            <td>Fecha de Emisión   '.$objSolicitud->set_fecha($datos[0]["fechaemision"]).'</td>
        </tr>
        <tr>
            <td>Departamento que Solicita: Taller</td>
            <td></td>
        </tr>
    </table>
	...
	<table class="table table-bordered table-condensed">
                ...
                <center>
                    Elaborado Por:_________________ Autorizado Por:_________________ Recibido Por:_________________
                </center>
...
$dompdf->render();
$dompdf->stream("ordencompra".".pdf",array('Attachment'=>0));
?>