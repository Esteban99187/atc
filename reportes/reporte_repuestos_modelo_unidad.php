...
<?php
	...
	$dataDetalle = $detalle->buscar_repuestos();	
...
<table border="1" width="100%" cellspacing="0">
	<caption style="padding:10px; font-size:20px; border:1px solid black; border-bottom:none;">Lista de repuestos por modelo de unidad</caption>
	<tr>
	...
	<?php foreach($dataDetalle as $midetalle ){ ?>
			<tr>
				<td><?php print($midetalle["nombre_repuesto"]); ?></td>
				<td><?php print($midetalle["desc_mode"]); ?></td>
				<td><?php print($midetalle["cantidad"]); ?></td>
			</tr>
	<?php } ?>
