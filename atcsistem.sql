...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-07-2016 a las 23:22:19
...
(80, 'MARIAOCANTO', 'DIRECCION ', 'ACARIGUA'),
...
('albertdesinger', 20467294, 'alberto', 'vargas', '', 'ticobboy@gmail.com', 'TICO20467294', 1, '2015-08-23 21:21:57', 1, 1, 1, 'j21563703'),
...
('cesar12', 24146295, 'CESAR AUGUSTO', 'BELLO', '04245419940', 'CESAR_MADRID_93@HOTMAIL.COM', '308447814fbdac79ca36494137962735', 0, '2016-06-08 13:32:54', 1, 1, 21, NULL),
('cesarbello', 19455541, 'cecar', 'bello', '', '', 'aca0831051fee66903cac2553701e32a', 0, '2015-08-25 04:51:20', 1, 1, 1, NULL),
...
('dexia', 19714949, 'CARLOS ', 'DELGADO', '04126769941', 'CARLOS@HOTMAIL.COM', '1c33a6bd69c2cf95a8ebacc440011f6b', 7, '2016-05-31 20:05:26', 1, 1, 3, NULL),
...
('mariaocanto', 20657234, 'MARIA', 'ALVAREZ', '04245419940', 'CESAR_MADRID_93@HOTMAIL.COM', '669a6cd0d0b4897159a42f14da21b0fa', 0, '2016-07-04 19:37:15', 1, 1, 23, NULL),
...
('yamnu', 25161310, 'YAMNUARIS', 'GUEDEZ', '04126737823', 'ALGUNO@HOTMAIL.COM', 'b30d1d7e137ca611900991df24be6d5b', 0, '2016-05-13 15:07:57', 1, 1, 21, NULL),
('yanerya', 5950128, 'YANERY', 'ALVAREZ', '04245564231', 'CESAR_MADRID_93@HOTMAIL.COM', 'afe2d132dfb4386a13f34f826356acec', 0, '2016-06-08 12:49:55', 1, 1, 22, NULL),
...
--
ALTER TABLE `bitacora`
MODIFY `IdBitacora` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=193;
--
...
--
ALTER TABLE `menu`
MODIFY `IdMenu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=63;
--
-- AUTO_INCREMENT de la tabla `menu_operacion`
--
ALTER TABLE `menu_operacion`
MODIFY `IdMenu_Operacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=129;
--
...
--
ALTER TABLE `perfil_menu`
MODIFY `IdPerfil_Menu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=66;
--
