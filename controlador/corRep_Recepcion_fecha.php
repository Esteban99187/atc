<?php
   ...
   if(array_key_exists(txtoperacion,$_POST))
   {
	   ...
	   $lobjbusqueda= new clsRep_Recepcion_fecha(); 
   ...
   if ($lsOperacion=="buscar")
   {
	 $_SESSION['matriz']=$lobjbusqueda->fBusqueda();
	  ...
	  $lsbusqueda=$lobjbusqueda->fGetsbusqueda();
			...
			header("location: ../vista/admin.php?url=visRep_Recepcion_fecha&lsOperacion=$lsOperacion&liHay=$liHay&lsbusqueda=$lsbusqueda&lsfini=$lsfini&lsfin=$lsfin");
   }
