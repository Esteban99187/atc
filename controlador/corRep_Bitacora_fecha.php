<?php
   ...
   if(array_key_exists(txtoperacion,$_POST))
   {
	   ...
	   $lobjbusqueda= new clsRep_Bitacora_fecha(); 
   ...
   if ($lsOperacion=="buscar")
   {
	 $_SESSION['matriz']=$lobjbusqueda->fBusqueda();
	  ...
	  $lsbusqueda=$lobjbusqueda->fGetsbusqueda();
			...
			header("location: ../vista/admin.php?url=visRep_Bitacora_fecha&lsOperacion=$lsOperacion&liHay=$liHay&lsbusqueda=$lsbusqueda&lsfini=$lsfini&lsfin=$lsfin");
   }
