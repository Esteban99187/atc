<?php
  ...
  //if(!array_key_exists(nombre,$_SESSION)) 
   //{
    ...
    //}
   require_once("../pdf/clsFpdf3.php");
   require_once("../modelo/clsRep_solicitudt.php");   
   $lobjPdf=new clsFpdf();
   ...
   $laMatriz=$lobjclsRep_solicitudt->fBusqueda();
      ...
      $lobjPdf->SetY(50);
	   ...
	   for($liI=0;$liI<count($laMatriz);$liI++){
		...
		$lobjPdf->Cell(2,6,utf8_decode($laMatriz[$liI][2]),0,0,"C");
		$lobjPdf->SetFont("arial","",12);
		...
		$lobjPdf->Cell(30,6,utf8_decode($laMatriz[$liI][2]),0,1,"C");
	$lobjPdf->Ln(2);
		$lobjPdf->Cell(111,6,utf8_decode("Cedula de Identidad:"),0,0,"C");
		$lobjPdf->Cell(30,6,utf8_decode($laMatriz[$liI][7]),0,1,"C");
		$lobjPdf->Ln(2);
