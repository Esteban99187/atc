...
class ModeloBuscarAjax extends clsConex{
	...
	function ConsultarTodoAjaxcliente($status,$valor)
	{
		if($status == "1" && $valor == "" )
		{ //busco por estatus activos
			$sql = "SELECT * FROM cliente as e WHERE (e.estatus_cli like '1') ";
			return $this->ejecuta($sql);
		}
		else if($status == "0" && $valor == "" )
		{ //busco por estatus inactivos
			$sql = "SELECT * FROM cliente as e WHERE (e.estatus_cli like '0')";
			return $this->ejecuta($sql);
		}
		else if($status == "1" && $valor != "" )
		{ //busco por nombres y por estatus activos
			$sql = "SELECT * FROM cliente as e WHERE (e.nombre_cli like '%$valor%' and e.estatus_cli like '1')";
			return $this->ejecuta($sql);
		}
		else if($status == "0" && $valor != "" )
		{ //busco por nombres y por estatus inactivos
			$sql = "SELECT * FROM cliente as e WHERE (e.nombre_cli like '%$valor%' and e.estatus_cli like '0')";
			return $this->ejecuta($sql);
		}
		else if($valor != "")
		{ //busco solo por nombres
			$sql = "SELECT * FROM cliente as e WHERE (e.nombre_cli like '%$valor%')";
			return $this->ejecuta($sql);
		}
		else
		{ // busco cuando borran en la caja de texto y cuando destildan el checkbox (viene siendo como el general);
			$sql = "SELECT * FROM cliente as e WHERE (e.nombre_cli like '%$valor%')";
			return $this->ejecuta($sql);
		}
	}
	
	function getCliente($rs)
	{
...
//~ ******************************************************************
	...
	//~ ******************************************************************
	//~ funciones que permiter consultar los datos de un registro o tabla
	function ConsultarTodoConductoratc(){
		$sql = "SELECT * FROM persona where (cod_rol='9') LIMIT 15";
		return $this->ejecuta($sql);
	}
	function ConsultarTodoAjaxConductoratc($status,$valor){
		if($status == "1" && $valor == "" ){ //busco por estatus activos
...
//~ funciones que permiter consultar los datos de un registro o tabla
	function ConsultarTodotipoproducto(){
		$sql = "SELECT * FROM tipo_producto LIMIT 15";
		return $this->ejecuta($sql);
	}
	function ConsultarTodoAjaxTipoproducto($status,$valor){
		if($status == "1" && $valor == "" ){ //busco por estatus activos
			$sql = "SELECT * FROM tipo_producto as e WHERE (e.estatus_tippro like '1') ";
			return $this->ejecuta($sql);
		}else if($status == "0" && $valor == "" ){ //busco por estatus inactivos
			$sql = "SELECT * FROM tipo_producto as e WHERE (e.estatus_tippro like '0') ";
			return $this->ejecuta($sql);
		}else if($status == "1" && $valor != "" ){ //busco por nombres y por estatus activos
			$sql = "SELECT * FROM tipo_producto as e WHERE (e.desc_tipo_prod like '%$valor%' and e.estatus_tippro like '1')";
			return $this->ejecuta($sql);
		}else if($status == "0" && $valor != "" ){ //busco por nombres y por estatus inactivos
			$sql = "SELECT * FROM tipo_producto as e WHERE (e.desc_tipo_prod like '%$valor%' and e.estatus_tippro like '0')";
			return $this->ejecuta($sql);
		}else if($valor != ""){ //busco solo por nombres
			$sql = "SELECT * FROM tipo_producto as e WHERE (e.desc_tipo_prod like '%$valor%')";
			return $this->ejecuta($sql);
		}else{ // busco cuando borran en la caja de texto y cuando destildan el checkbox (viene siendo como el general);
			$sql = "SELECT * FROM tipo_producto as e WHERE (e.desc_tipo_prod like '%$valor%')";
			return $this->ejecuta($sql);
