<?php
	...
	class clsRep_Orden_tabulador_destino extends class_db{
		...
		public function fBusqueda(){
            ...
            and  relacion_unidad.idremolque_reluni=remolque.idremolque 
            and  relacion_unidad.idunidad_reluni=unidad.idunidad 
            and  orden_carga.idrelacion_unidad=relacion_unidad.idconductor and VTabuladorDestino.ciudad_destino_vtd='$this->asbusqueda')"; 
			}
			$this->fConectar();
