<?php
	...
	class clsRep_Recepcion_fecha extends class_db{
		...
		public function fBusqueda(){
            ...
            and  relacion_unidad.idremolque_reluni=remolque.idremolque 
            and  relacion_unidad.idunidad_reluni=unidad.idunidad 
            and  orden_carga.idrelacion_unidad=relacion_unidad.idconductor and recepcion_guia.idorden_carga=orden_carga.idorden_carga and cliente.idcliente='$this->asbusqueda' and (recepcion_guia.fecha_hora_recgui between('$this->asfini 00:00:00') and ('$this->asfin 23:59:00')) and orden_carga.estatus_ordcar='ejecutada')";
			}
			$this->fConectar();
