<?php
	...
	class class_db{
		...
		protected function fconectar() { //función para conectar con mysql
			global $configServer;
			$this->arCon=mysql_connect($configServer["mysql"]["server"],$configServer["mysql"]["user"],$configServer["mysql"]["pass"]) OR die('No pudo conectarse: ' . mysql_error());  //conecta con mysql
			mysql_select_db($configServer["BD"],$this->arCon) OR die('Invalida Selección: ' . mysql_error()); //selecciona la base de datos a trabajar en el software
