	...
	if($_POST['tipo_repuesto']=="2"){
	 	...
	 	$objRL->tipo_lubricante = $_POST['tipo_lubricante'];
	}else{
	...
	function transaccion($idBuscado=1,$id_A_buscar="",$tipoOperacion=2){
		...
		if($idBuscado==1){
			$objDetalleUnidades->id_repuesto= $_POST['id_repuesto'];
		}else{
